...
const dbConfig = {
  ...
  connectString: '(DESCRIPTION = (ENABLE=BROKEN)(ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST = TALOPRHQ3.spor-talo.local)(PORT = 1546))(ADDRESS = (PROTOCOL = TCP)(HOST = TALOPRHQ2.spor-talo.local)(PORT = 1546))(ADDRESS = (PROTOCOL = TCP)(HOST = TALOPRHQ1.spor-talo.local)(PORT = 1546))(LOAD_BALANCE = OFF)) (CONNECT_DATA = (SERVICE_NAME = HQ1_SN) (UR = A)))'
};
