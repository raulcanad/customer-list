...
const dbConfig = {
  ...
  connectString: '(DESCRIPTION=(CONNECT_TIMEOUT=15)(RETRY_COUNT=3)(TRANSPORT_CONNECT_TIMEOUT=3)(ADDRESS_LIST =(ADDRESS = (PROTOCOL = TCP)(HOST = TENBPRHQ1.optima.local)(PORT = 1535))(ADDRESS = (PROTOCOL = TCP)(HOST = TENBPRHQ2.optima.local)(PORT = 1535))(LOAD_BALANCE =OFF))(CONNECT_DATA = (SERVICE_NAME = HQ1_SN) (UR = A)))'
};
