...
const dbConfig = {
  ...
  connectString: '(DESCRIPTION=(CONNECT_TIMEOUT=15)(RETRY_COUNT=3)(TRANSPORT_CONNECT_TIMEOUT=3)(ADDRESS_LIST =(ADDRESS = (PROTOCOL = TCP)(HOST = NTOPR1HQ1.nt-optima.local)(PORT = 1552))(ADDRESS = (PROTOCOL = TCP)(HOST = NTOPR1HQ2.nt-optima.local)(PORT = 1553))(LOAD_BALANCE =OFF))(CONNECT_DATA = (SERVICE_NAME = HQ1_SN)))'
};
