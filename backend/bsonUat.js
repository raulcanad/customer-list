...
const dbConfig = {
  ...
  connectString: '(DESCRIPTION=(CONNECT_TIMEOUT=15)(RETRY_COUNT=3)(TRANSPORT_CONNECT_TIMEOUT=3)(ADDRESS_LIST =(ADDRESS = (PROTOCOL = TCP)(HOST = BSONUAHQ1.dev.local)(PORT = 1539))(ADDRESS = (PROTOCOL = TCP)(HOST = oc-uat-dbc-04)(PORT = 1539))(LOAD_BALANCE =OFF))(CONNECT_DATA = (SERVICE_NAME = HQ1_SN) (UR = A)))'
};
